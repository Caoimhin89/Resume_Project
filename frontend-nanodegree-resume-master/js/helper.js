...
var HTMLskypePhone = '<li class="flex-item"><span class="orange-text">Skype Phone</span><span class="white-text">%data%</span></li>';
...
var HTMLskillsStart = '<h3 id="skillsH3">Skills at a Glance:</h3><ul id="skills-C1" class="flex-box"></ul><ul id="skills-C2" class="flex-box"></ul>';
